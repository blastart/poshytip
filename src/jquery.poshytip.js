...
(function($, document, window) {
    ...
    $.Poshytip.prototype = {
        ...
        mouseleave: function(e) {
            if (this.disabled || this.asyncAnimating && (this.$tip[0] === e.relatedTarget || $.contains(this.$tip[0], e.relatedTarget))) {
                return true;
            }
        ...
        refresh: function(async) {
            ...
            if (bgImage) {
                ...
                if (IE6 && bgImagePNG) {
                    ...
                    this.$tip.prepend(
                        '<table class="tip-table" border="0" cellpadding="0" cellspacing="0">'+
                            '<tr><td class="tip-top tip-bg-image" colspan="2">'+
                                '<span></span></td><td class="tip-right tip-bg-image" rowspan="2"><span></span></td>'+
                            '</tr>'+
                            '<tr><td class="tip-left tip-bg-image" rowspan="2"><span></span></td><td></td></tr>'+
                            '<tr><td class="tip-bottom tip-bg-image" colspan="2"><span></span></td></tr>'+
                        '</table>'
                    )
    ...
    // default settings
    $.fn.poshytip.debounce = debounce;      // a reference of the debounce object to modify.
